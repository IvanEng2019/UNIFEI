...
int main(){
   ...
   if( ret>0 && ret1>0 && ret2>0)
        printf( "%s - %s - %s ",cadeia[2],cadeia[1],cadeia[0]);
   if( ret>0 && ret1>0 && ret2<0)
        printf( "%s - %s - %s ",cadeia[1],cadeia[2],cadeia[0]);
   if ( ret>0 && ret1<0 && ret2<0)
        printf( "%s - %s - %s ",cadeia[1],cadeia[0],cadeia[2]);
   if ( ret<0 && ret1>0 && ret2>0)
        printf( "%s - %s - %s ",cadeia[0],cadeia[2],cadeia[1]);
   if ( ret<0 && ret1<0 && ret2<0)
        printf( "%s - %s - %s ",cadeia[0],cadeia[1],cadeia[2]);
return 0;
}
